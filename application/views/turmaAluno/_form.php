    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="dtNascimento" class="form-control" value="<?php echo isset($model->dtNascimento) ? $model->dtNascimento : set_value('dtNascimento') ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <label for="">CPF:</label>
                <input type="text" name="cpf" class="form-control" value="<?php echo isset($model->cpf) ? $model->cpf : set_value('cpf') ?>">
            </div>
            <div class="col-md-4">
