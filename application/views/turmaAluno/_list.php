...
<table class="table table-bordered table-hover responsive" id="table" style="width: 100% !important;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo base_url() ?>/turmaaluno/editar/<?php echo $turmas[$counter]->id?>" data-toggle="tooltip" title="Editar"><i class="fa fa-edit"></i></a>
                <a href="<?php echo base_url() ?>/turmaaluno/deletar/<?php echo $turmas[$counter]->id ?>" data-toggle="tooltip" title="Deletar"><i class="fa fa-remove"></i></a>
            </td>
        </tr>
    <?php
        $counter ++;
