                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <p>
                                            <b>Código:</b> <?php echo $model->codigo ?><br>
                                            ...
                                            <b>Horário: </b> <?php echo $model->horario ?> <br>

                                        </p>
                                        <a href="<?php echo base_url() ?>/turma/editar/<?php echo $model->id ?>" name="button" class="btn btn-warning" data-toggle="tooltip" data-title="Clique aqui para editar a Turma">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="col-md-4">
                                            ...
                                            <a href="<?php echo base_url() ?>/professor/editar/<?php echo $this->professor_model->get($model->professor_id)->id ?>" name="button" class="btn btn-warning" data-toggle="tooltip" data-title="Clique aqui para editar o Professor">
                                                <i class="fa fa-edit"></i> Editar
                                            </a>
                                        </div>
                                        <div class="col-md-8">
                                            <p>
                                                <b>Nome: </b><?php echo implode(' ', [$this->professor_model->get($model->professor_id)->nome, $this->professor_model->get($model->professor_id)->sobrenome]) ?> <br>
                                                <b>Biografia: </b> <p><?php echo $this->professor_model->get($model->professor_id)->bio ?></p>
                                                <b>Observação: </b> <p><?php echo $this->professor_model->get($model->professor_id)->observacao ?></p>
                                                <b>Contrato: </b> <p><?php echo $this->professor_model->get($model->professor_id)->contrato ?></p>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <?php
                                    ...
                                    if(empty($turmas)){
                                        ...
                                        ?>
                                            <b>Código:</b> <?php echo $curso->codigo ?> <br>
                                            <b>Nome do Curso:</b> <?php echo $curso->nome ?> <br>
